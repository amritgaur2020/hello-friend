...
interface RestaurantKOTPrintProps {
  order: DepartmentOrder;
  items: DepartmentOrderItem[];
  kotNumber?: number;
}

export const RestaurantKOTPrint = forwardRef<HTMLDivElement, RestaurantKOTPrintProps>(
    ...
    return (
      ...
      >
        ...
        <div className="text-center pt-2 border-t-2 border-black border-dashed text-[10px]">
          <p className="font-bold">{settings?.hotel_name || 'RESTAURANT'}</p>
...
RestaurantKOTPrint.displayName = 'RestaurantKOTPrint';
